{
  inputs =
    let
      version = "1.10.0";
system = "x86_64-linux";
devenv_root = "/home/jeanluc/Code/code-arena";
devenv_dotfile = "/home/jeanluc/Code/code-arena/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-70c6e2e";
...
hostname = "desktop";
username = "jeanluc";
git_root = "/home/jeanluc/Code/code-arena";
